...
project_name <- "test_output/Scripting_test_Chambers_050118"
protein_file <- "data/TMTphos_Chambers_050118/proteinGroups.txt"
samples_file <- "data/TMTphos_Chambers_050118/Chambers_sample_table_060420.tsv"
phospho_file <- "data/TMTphos_Chambers_050118/Phospho (STY)Sites.txt"
