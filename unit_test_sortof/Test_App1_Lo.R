...
project_name <- "test_output/Scripting_test_Lo"
protein_file <- "data/TMTphos_Lo_021020/Lo_proteinGroups_Human.txt"
samples_file <- "data/TMTphos_Lo_021020/Lo_sample_table_060420_good.txt"
phospho_file <- "data/TMTphos_Lo_021020/Phospho (STY)Sites_human.txt"
